export const publishResult = async ({ playerName, chapterPlayed, score, gameLength }) => {
  ...
  const data = {
    access_token: "5ca21c6a6b0d313c0b72032da5e3179cdf0bf5726aa2a20af5aa46b92853",
    title: "Exam Results",
  ...
  const dataAsParams = Object.entries(data).reduce((acc, [key, value]) => `${acc}${key}=${value}&`, "");
...
const getResults = async () => {
  const res = await fetch("https://api.telegra.ph/getPage/Exam-Results-06-11?return_content=true");
